...
<nav id="toc" class="action-bar">
    ...
    <div class="nav-item"><a href="#timeline">Timeline</a></div>
    <div class="nav-item"><a href="#dining">Dining</a></div>
    <div class="nav-item"><a href="#activities">Vibes</a></div>
</nav>
...
<div class="frame">
  ...
  <div class="front">
		<div>
			...
			<div>
				<div class="info">
					 <b>Precipitation:</b> 10% <br> <b>Humidity:</b> 68% <br> <b>Wind:</b> 1 mph
				</div>
			</div>
		</div>
	</div>
  ...
  <ul>
    <li><span></span>
      <div>
        ...
        <div class="info">Two spots available inside garage on a first-come, first-served basis. Street parking for overflow.</div>
        <div class="type">Assembly</div>
      </div> <span class="number"><span>5:00 PM</span> <span>6:00 PM</span></span>
    </li>
    <li>
      <div><span></span>
        <div class="title">Feast: Main</div>
        <div class="info">See menu below.</div>
        <div class="type">Dining</div>
      </div> <span class="number"><span>6:30 PM</span> <span>7:00 PM</span></span>
    </li>
    <li>
      <div><span></span>
        <div class="title">Feast: Desserts</div>
        <div class="info">Assortment of fruits and sweets brought by guests.</div>
        <div class="type">Dining</div>
      </div> <span class="number"><span>7:30 PM</span> <span>8:00 PM</span></span>
    </li>
    <li>
      <div><span></span>
        <div class="title">Post-Meal Activities</div>
        <div class="info">Music, board games, and chat.</div>
        <div class="type">Vibes</div>
      </div> <span class="number"><span>8:30 PM</span> <span>10:30 PM</span></span>
    </li>
    <li>
      <div><span></span>
        <div class="title">Farewell</div>
        <div class="info">Distribute leftovers (if any) to guests to take back to their respective planets.</div>
        <div class="type">Dispersion</div>
      </div> <span class="number"><span>10:45 PM</span> <span>11:00 PM</span></span>
    </li>
  </ul>
</div>
...
<h2 id="activities">Vibes</h2>

### Background Playlist
#### Dining
<iframe width="100%" height="315" src="https://www.youtube.com/embed/iKUgTi6CWjU" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

<br>

#### Activities
<iframe width="100%" height="315" src="https://www.youtube.com/embed/70CJDNLrkdg?list=PLR2ASshVNGeg8sz8lv_XHYoL0i7jUx6fY" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
### Hologram Cameos
To join virtually, please see your email invite to join via Google Meet.
<br>
